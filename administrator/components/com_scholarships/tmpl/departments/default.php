...
?>
<form action="<?php echo Route::_('index.php?option=com_scholarships&view=departments'); ?>" method="post" name="adminForm" id="adminForm">
    <div class="row">
        <div class="col-md-12">
                ...
                <?php else : ?>
                    <table class="table" id="scholarshipStatusList">
                        ...
                        <tr>
                            ...
                            <th scope="col">
                                <?php echo Text::_('COM_SCHOLARSHIPS_DEPARTMENT_TABLE_TABLEHEAD_NAME'); ?>
                            </th>
                            <th scope="col">
                        ...
                        foreach ($this->items as $i => $item) :
                            ...
                            <tr class="row<?php echo $i % 2; ?>">
                                ...
                                <th scope="row" class="has-context">
                                    ...
                                    <a class="hasTooltip" href="<?php echo Route::_('index.php?option=com_scholarships&task=department.edit&id=' . (int) $item->id); ?>" title="<?php echo Text::_('JACTION_EDIT'); ?> <?php echo $this->escape(addslashes($item->name)); ?>">
                                        <?php echo $editIcon; ?><?php echo $this->escape($item->name); ?></a>
                                </th>
                                <td class="scholarship-status text-center">
                                    <?php
                                    $options = [
                                        'task_prefix' => 'departments.',
