...
?>
<form action="<?php echo Route::_('index.php?option=com_scholarships&view=optiontypes')?>" method="post" name="adminForm" id="adminForm">
    <div class="row">
        <div class="col-md-12">
            <div id="j-main-container" class="j-main-container">
                ...
                <?php else : ?>
                <table class="table" id="scholarshipOptionTypesList">
                    <thead>
                        <tr>
                            <td class="w-1 test-center">
                                <?php echo HTMLHelper::_('grid.checkall'); ?>
                            </td>
                            <th scope="col">
                                <?php echo Text::_('COM_SCHOLARSHIPS_OPTION_TYPE_TABLEHEAD_NAME'); ?>
                            </th>
                            <th scope="col">
                    ...
                    <?php
                        ...
                        <tr class="row<?php echo $i % 2; ?>">
                            ...
                            <th scope="row" class="has-context">
                                ...
                                <a class="hasTooltip" href="<?php echo Route::_('index.php?option=com_scholarships&task=optiontype.edit&id=' . (int) $item->id); ?>" title="<?php echo Text::_('JACTION_EDIT'); ?> <?php echo $this->escape(addslashes($item->name)); ?>">
                                    <?php echo $editIcon; ?><?php echo $this->escape($item->name); ?></a>
                            </th>
                            <td class="optiontype-status text-center">
                                <?php
                                $options = [
                                    'task_prefix' => 'optiontypes.',
