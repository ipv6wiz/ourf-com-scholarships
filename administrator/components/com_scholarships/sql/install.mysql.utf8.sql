...
CREATE TABLE `#__scholarships` (
                                     ...
                                     `scholarship_fk_scholarship_college` INT DEFAULT 0,
                                     `scholarship_fk_scholarship_department` INT DEFAULT 0,
...
values  (1, '2006', 'Syarifah Lia Andriati', 5, 1, 1, 'Feeding Behavior of Sumatran Orangutan (Pongo abelii) and Local People Perception on Their Existence in Farmland (A Case Study in Subdistrict of Batang Serangan, Langkat District)', 'Work in BNI Medan as Corporate Social Responsibility (CSR)  officer', '/abstracts/syarifah_abstract.pdf', 'Feeding Behavior of Sumatran Orangutan and People Perception on Their Existence in Farmland ', '', 0, 1, 10),
