...
abstract class AssociationHelper extends CategoryAssociationHelper
{
	...
	public static function getAssociations($id = 0, $view = null, $layout = null)
	{
		...
		if ($layout === null && $jinput->get('view') == $view && $component == 'com_scholarships')
		{
		...
		if ($view === 'article')
		{
			if ($id)
			{
				...
				if (!$user->authorise('core.edit.state', 'com_content') && !$user->authorise('core.edit', 'com_scholarships'))
				{
